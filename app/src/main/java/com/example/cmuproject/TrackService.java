...
public class TrackService extends Service {
    ...
    private void onNewLocation(Location location) {
        ...
        if(userLastLoc==null || location.getLatitude()!=userLastLoc.getLatitude() || location.getLongitude()!=userLastLoc.getLongitude() ){
            if(userLastLoc!=null){
            System.out.println(location.getLatitude()!= userLastLoc.getLatitude());
                System.out.println(location.getLongitude()!=userLastLoc.getLongitude());}
            userLastLoc=location;
            //System.out.println(userLocationDao.getCountLocations());
            MedicamentosDB.databaseWriteExecutor.execute(()->{
                //hora e dia
                System.out.println("Alterou o dia e a hora na base da dados");
                ...
                userLocationDao.insertLocation(new UserLocation(userLastLoc.getLatitude(),userLastLoc.getLongitude(),dateInString,hour));
            });
